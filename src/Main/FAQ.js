              ...
              <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-8">
                  <div class="hero-txt text-center white-color">
                    ...
                    <p class="p-xl">
                      frequntly asked questions description frequntly asked
                      questions description frequntly asked questions
                      description frequntly asked questions description{" "}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-3 text-end">
                  <div class="cta-7-btn">
                    <a
                      href="contacts.html"
                      class="btn btn-skyblue tra-grey-hover"
                    >
                      Contact Us
                    </a>
                  </div>
